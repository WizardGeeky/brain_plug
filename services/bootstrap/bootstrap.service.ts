    ...
    try {
      ...
      const defaultModels = [
        ...
        },
        {
          ...
          provider: "Google",
          description: "Ultra low-latency lightweight multimodal model for instant widget chat.",
          status: ModelStatus.ACTIVE,
          isPublished: true,
          inputTokenPrice: 0,
          outputTokenPrice: 0,
        ...
        },
        {
          ...
          provider: "Google",
          description: "Google state-of-the-art 768-dim semantic document embedding model.",
          status: ModelStatus.ACTIVE,
          isPublished: true,
          inputTokenPrice: 0,
          outputTokenPrice: 0,
